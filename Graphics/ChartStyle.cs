...
{
	//Класс служит для определения координат точки на заданном холсте
...
//Свойства для задания размеров и расположения системы координат на холсте
...
//метод для определения координат точки на заданном холсте
